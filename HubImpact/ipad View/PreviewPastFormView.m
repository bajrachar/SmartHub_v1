...
//
   ...
   // NSString *URL=[NSString stringWithFormat:@"http://182.93.95.189/auth.Smarthub/api/search?keyword=%@",keyword];
    ...
    NSLog([NSString stringWithFormat:@"http://182.93.95.189/auth.Smarthub/api/search?keyword=%@&page=1&perpage=100&orderby=CreatedDate&PropertyAddress=%@&PreparedBy=%@&FromDate=%@&ToDate=%@", keyword, propertyAddress,prepairedBy,fromDate,toDate]);
