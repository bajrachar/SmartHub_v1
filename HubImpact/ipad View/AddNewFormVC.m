...
@property (readonly) BOOL isVisualCommentsCapturersLocked;

@property BOOL visualCommentsImageUploadInProgress;

@property (strong, nonatomic) NSMutableDictionary* visualCommentsImageURLs;
@property (strong, nonatomic) NSString* keyForActiveVisualComments;

@property (strong, nonatomic) UIButton* tappedVisualCommentsButton;
...
-(BOOL) isVisualCommentsCapturersLocked {
    return self.visualCommentsImageUploadInProgress;
}
...
-(NSMutableDictionary*)visualCommentsImageURLs{
    if(!_visualCommentsImageURLs){
        _visualCommentsImageURLs=[[NSMutableDictionary alloc]init];
        NSArray* keys = [NSArray arrayWithObjects:@"Gutters",@"Windows",@"Walls",@"Roof/Tiles",@"Fencing",@"Gates",@"Garden",@"CommonArea",@"SmokeDetectors",nil];
        NSArray* objects = [NSArray arrayWithObjects:@"N/A",@"N/A",@"N/A",@"N/A",@"N/A",@"N/A",@"N/A",@"N/A",@"N/A",nil];
        _visualCommentsImageURLs=[NSMutableDictionary dictionaryWithObjects:objects forKeys:keys];
        
    }
    return _visualCommentsImageURLs;
}
...
-(IBAction)pickImage:(UIButton*)sender{
    ...
    if (self.isVisualCommentsCapturersLocked) {
        return;
    }
    
    [self lockVisualCommentsImageCapturers];
    self.tappedVisualCommentsButton=sender;
    
    switch (sender.tag) {
        case 100:
            self.keyForActiveVisualComments = @"Gutters";
            break;
        case 101:
            self.keyForActiveVisualComments = @"Windows";
            break;
        case 102:
            self.keyForActiveVisualComments = @"Walls";
            break;
        case 103:
            self.keyForActiveVisualComments = @"Roof/Tiles";
            break;
        case 104:
            self.keyForActiveVisualComments = @"Fencing";
            break;
        case 105:
            self.keyForActiveVisualComments = @"Gates";
            break;
        case 106:
            self.keyForActiveVisualComments = @"Garden";
            break;
        case 107:
            self.keyForActiveVisualComments = @"CommonArea";
            break;
        case 108:
            self.keyForActiveVisualComments = @"SmokeDetectors";
            break;
...
- (void)actionSheet:(UIActionSheet *)actionSheet clickedButtonAtIndex:(NSInteger)buttonIndex {
    if(buttonIndex == 0){
        ...
        else
        {
            ...
            [self unlockVisualCommentsImageCapturers];
    ...
    else
    {
        ...
        if(self.isVisualCommentsCapturersLocked) {
            [self.tappedVisualCommentsButton setBackgroundImage:[UIImage imageNamed:@"SelectImage.png"] forState:UIControlStateNormal];
            [self unlockCleanlinessImageCapturers];
        }
...
-(void) uploadCleanlinessImageToCloudinary:(UIImage*) imageToUpload {
    [self uploadToCloudinary:imageToUpload];
}

-(void) uploadVisualCommentsImageToCloudinary:(UIImage*) imageToUpload {
    [self uploadToCloudinary:imageToUpload];
}

-(void) uploadToCloudinary: (UIImage*) imageToUpload {
...
-(void) lockVisualCommentsImageCapturers {
    self.visualCommentsImageUploadInProgress = YES;
}

-(void) unlockVisualCommentsImageCapturers {
    self.visualCommentsImageUploadInProgress = NO;
}
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingImage:(UIImage *)image editingInfo:(NSDictionary *)editingInfo
{
    ...
    if (self.isVisualCommentsCapturersLocked) {
        [self.tappedVisualCommentsButton setImage:image forState:UIControlStateNormal];
        [self uploadVisualCommentsImageToCloudinary:image];
    }
                                                    ...
                                                    @{
                                                        @"Fields": @[
                                                                ...
                                                                @{
                                                                    ...
                                                                    @"DisplayOrder": @"0"                                                                    },
                                                                // images for visual comment
                                                                
                                                     
                                                                
                                                                @{
                                                                    @"FieldName": @"GutterImage",
                                                                    @"DisplayLabel": @"GutterImage",
                                                                    @"DataType": @"ImageURL",
                                                                    @"IsRequired": @"false",
                                                                    @"Value":  [self.visualCommentsImageURLs objectForKey:@"Gutters"],
                                                                    @"DisplayOrder": @"0"                                                                    },
                                                                @{
                                                                    @"FieldName": @"WindowImage",
                                                                    @"DisplayLabel": @"WindowImage",
                                                                    @"DataType": @"ImageURL",
                                                                    @"IsRequired": @"false",
                                                                    @"Value":  [self.visualCommentsImageURLs objectForKey:@"Windows"],
                                                                    @"DisplayOrder": @"0"                                                                    },
                                                                @{
                                                                    @"FieldName": @"WallsImage",
                                                                    @"DisplayLabel": @"WallsImage",
                                                                    @"DataType": @"ImageURL",
                                                                    @"IsRequired": @"false",
                                                                    @"Value":  [self.visualCommentsImageURLs objectForKey:@"Walls"],
                                                                    @"DisplayOrder": @"0"                                                                    },
                                                                @{
                                                                    @"FieldName": @"RoomTilesImage",
                                                                    @"DisplayLabel": @"RoomTileImage",
                                                                    @"DataType": @"ImageURL",
                                                                    @"IsRequired": @"false",
                                                                    @"Value":  [self.visualCommentsImageURLs objectForKey:@"Roof/Tiles"],
                                                                    @"DisplayOrder": @"0"                                                                    },
                                                                @{
                                                                    @"FieldName": @"FencingImage",
                                                                    @"DisplayLabel": @"FencingImage",
                                                                    @"DataType": @"ImageURL",
                                                                    @"IsRequired": @"false",
                                                                    @"Value":  [self.visualCommentsImageURLs objectForKey:@"Fencing"],
                                                                    @"DisplayOrder": @"0"                                                                    },
                                                                @{
                                                                    @"FieldName": @"GatesImage",
                                                                    @"DisplayLabel": @"GatesImage",
                                                                    @"DataType": @"ImageURL",
                                                                    @"IsRequired": @"false",
                                                                    @"Value":  [self.visualCommentsImageURLs objectForKey:@"Gates"],
                                                                    @"DisplayOrder": @"0"                                                                    },
                                                                @{
                                                                    @"FieldName": @"GardenImage",
                                                                    @"DisplayLabel": @"GardenImage",
                                                                    @"DataType": @"imageURL",
                                                                    @"IsRequired": @"false",
                                                                    @"Value":  [self.visualCommentsImageURLs objectForKey:@"Garden"],
                                                                    @"DisplayOrder": @"0"                                                                    },
                                                                @{
                                                                    @"FieldName": @"CommAreaImage",
                                                                    @"DisplayLabel": @"CommAreaImage",
                                                                    @"DataType": @"ImageURL",
                                                                    @"IsRequired": @"false",
                                                                    @"Value":  [self.visualCommentsImageURLs objectForKey:@"CommonArea"],
                                                                    @"DisplayOrder": @"0"                                                                    },
                                                                @{
                                                                    @"FieldName": @"SmokeDetectorsImage",
                                                                    @"DisplayLabel": @"SmokeDetectorsImage",
                                                                    @"DataType": @"ImageURL",
                                                                    @"IsRequired": @"false",
                                                                    @"Value":  [self.visualCommentsImageURLs objectForKey:@"SmokeDetectors"],
                                                                    @"DisplayOrder": @"0"                                                                    },
...
- (void) uploaderSuccess:(NSDictionary*)result context:(id)context {
    ...
    if (self.isVisualCommentsCapturersLocked) {
        [self.visualCommentsImageURLs setObject:[result objectForKey:@"secure_url"] forKey:[NSString stringWithFormat:@"%@", self.keyForActiveVisualComments]];
        [self unlockVisualCommentsImageCapturers];
    }
...
- (void) uploaderProgress:(NSInteger)bytesWritten totalBytesWritten:(NSInteger)totalBytesWritten totalBytesExpectedToWrite:(NSInteger)totalBytesExpectedToWrite context:(id)context {
    ...
    if (self.isVisualCommentsCapturersLocked) {
        NSLog(@"Upload progress for visual comments image : %d/%d (+%d)", totalBytesWritten, totalBytesExpectedToWrite, bytesWritten);
    }
}
